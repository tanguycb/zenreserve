import { i as createLucideIcon, aK as useActor, b4 as useQuery, a8 as useQueryClient, aL as useMutation, aM as createActor, u as useTranslation, au as useAuth, j as jsxRuntimeExports, U as Users, aJ as LoaderCircle, O as Badge, at as TriangleAlert, t as ue, r as reactExports, w as Label, I as Input, B as Button } from "./index-BNayfcmF.js";
...
function useAddTeamMember() {
  ...
  return useMutation({
    ...
    onError: (_err, _payload, context) => {
      if ((context == null ? void 0 : context.previousMembers) !== void 0) {
...
const roleBadgeClass = {
  owner: "bg-[oklch(var(--status-orange)/0.15)] text-[oklch(var(--status-orange))] border border-[oklch(var(--status-orange)/0.3)]",
  manager: "bg-primary/15 text-primary border border-primary/30",
  marketing: "bg-[oklch(var(--status-blue)/0.15)] text-[oklch(var(--status-blue))] border border-[oklch(var(--status-blue)/0.3)]",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "px-6 py-6 space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: t("settings.team.form.principalIdHint") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 px-4 py-3 rounded-xl bg-muted/30 border border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 text-[oklch(var(--status-orange))] shrink-0 mt-0.5" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              type: "submit",
              disabled: !name.trim() || !email.trim() || !principalId.trim() || addMember.isPending,
              className: "gap-2",
