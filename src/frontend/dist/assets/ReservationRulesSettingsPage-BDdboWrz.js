import { k as createLucideIcon, u as useTranslation, a9 as useReservationRules, aa as useUpdateReservationRules, r as reactExports, j as jsxRuntimeExports, d as Clock, U as Users, b as ue, B as Button } from "./index-DYFUyfbw.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Section,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
              ...
              config.noShowFeeEur > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 px-4 py-3 rounded-xl bg-amber-500/10 border border-amber-500/20", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 text-amber-500 mt-0.5 shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-500/90", children: rr.noShowFeeNote })
              ] })
            ] })
          }
        ),
