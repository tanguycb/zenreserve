import { k as createLucideIcon, r as reactExports, j as jsxRuntimeExports, g as useComposedRefs, c as cn, v as useActor, w as useQuery, h as useQueryClient, x as useMutation, y as createActor, u as useTranslation, a1 as useNotificationSettings, a2 as useUpdateNotificationSettings, t as Bell, X, d as Clock, B as Button, S as Skeleton, e as Star, i as Badge, b as ue } from "./index-DYFUyfbw.js";
...
import { S as Switch } from "./switch-DNA66AFY.js";
import { P as Primitive, c as composeEventHandlers, a as createContextScope, u as useControllableState } from "./index-BSOAbKVe.js";
import { c as createCollection, u as useDirection, L as List$1 } from "./index-X9UmPngB.js";
import { u as useId, a as useCallbackRef } from "./index-C6PNYWHZ.js";
import { P as Presence } from "./index-FUSgI9cf.js";
import { M as Mail } from "./mail-Dr9le5WV.js";
import { C as CircleAlert } from "./circle-alert-DhAePUEQ.js";
import { C as CircleCheck } from "./circle-check-4uI1R4ln.js";
import { m as motion, A as AnimatePresence } from "./proxy-Dqo1clYu.js";
import { M as MessageSquare } from "./message-square-B8kb0T5K.js";
import { S as Save } from "./save-B-q7naKk.js";
import { R as RotateCcw } from "./rotate-ccw-BZUH3g_A.js";
import { C as ChevronDown } from "./chevron-down-jLlt1x2r.js";
import { U as Upload } from "./upload-Dt92ldA1.js";
import "./index-CuGPROYD.js";
/**
...
function saveAllToStorage(all) {
  try {
    localStorage.setItem(STORAGE_KEY$1, JSON.stringify(all));
  } catch {
  }
}
...
function useSaveEmailTemplate() {
  ...
  return useMutation({
    mutationFn: async (template) => {
      ...
      all[template.templateType] = template;
...
function NotificationsSettingsPage() {
  ...
  const [isNotifDirty, setIsNotifDirty] = reactExports.useState(false);
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-card shadow-subtle overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 text-amber-500 shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-400", children: t("settings.notifications.emailDisabledNote") })
          ] }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ToggleRow,
                {
                  ...
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-amber-400" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 text-amber-500 shrink-0 mt-0.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-400", children: t("reviewRequests.disabledNote", { ns: "settings" }) })
              ] }) }),
