import { k as createLucideIcon, u as useTranslation, r as reactExports, j as jsxRuntimeExports, C as CalendarDays, B as Button, S as Skeleton, b as ue, c as cn, i as Badge } from "./index-DYFUyfbw.js";
...
import { b as useSeasonalPeriods, c as useSaveSeasonalPeriod, d as useDeleteSeasonalPeriod, e as useToggleSeasonalPeriod, A as AVAILABLE_ZONES, f as detectOverlap } from "./useSeasonalAI-CKhrOwuM.js";
import { P as Plus } from "./plus-BLj3PxS_.js";
import { A as AnimatePresence, m as motion } from "./proxy-Dqo1clYu.js";
import { S as Sun } from "./sun-pH3-ua9S.js";
import { C as Check } from "./check-B47oZVza.js";
import { C as ChevronUp } from "./chevron-up-DdOlTu8m.js";
import { C as ChevronDown } from "./chevron-down-jLlt1x2r.js";
import { C as CircleAlert } from "./circle-alert-DhAePUEQ.js";
import { P as Pencil } from "./pencil-DJkvbev5.js";
...
const Snowflake = createLucideIcon("snowflake", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function SeasonIcon({ zones }) {
  if (zones.includes("terras") || zones.includes("rooftop"))
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4 w-4 text-amber-400" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Snowflake, { className: "h-4 w-4 text-sky-400" });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-2 pt-1", children: AVAILABLE_ZONES.map((zone) => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                ...
                !live && period.isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20 text-[10px] font-semibold px-2", children: t("settings.seasonal.statusActive") }),
                ...
                period.autoActivate && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-sky-500/10 text-sky-400 border-sky-500/20 text-[10px] font-medium px-2 gap-1", children: [
