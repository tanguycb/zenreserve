import { i as createLucideIcon, u as useTranslation, be as useIntegrationSettings, bf as useUpdateIntegrationSettings, r as reactExports, j as jsxRuntimeExports, w as Label, I as Input, at as TriangleAlert, B as Button, aa as RefreshCw, t as ue } from "./index-BNayfcmF.js";
...
function backendToConfig(b) {
  const posRaw = b.posSystem ?? "none";
  const knownPos = ["none", "lightspeed", "square", "toast", "custom"];
  const posSystem = knownPos.includes(posRaw) ? posRaw : "custom";
...
function configToBackend(c) {
  const posValue = c.posSystem === "custom" && c.customPosName ? c.customPosName : c.posSystem === "none" ? void 0 : c.posSystem;
  return {
...
function IntegrationsSettingsPage() {
  ...
  const handleSave = async () => {
    try {
      ...
      ue.error(err instanceof Error ? err.message : t("settings.saveError"));
    }
  };
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-48 rounded-xl bg-muted/40 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card h-48 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card h-32 animate-pulse" })
        ]
      }
    );
  }
        ...
        children: [
          ...
          bothPaymentsActive && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 text-[oklch(var(--status-orange))] mt-0.5 shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-[oklch(var(--status-orange)/0.9)]", children: t("settings.integrations.payments.bothEnabledWarning") })
              ]
            }
          )
        ]
