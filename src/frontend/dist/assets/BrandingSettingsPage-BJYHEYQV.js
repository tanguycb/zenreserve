import { k as createLucideIcon, u as useTranslation, a7 as useBrandingConfig, a8 as useUpdateBrandingConfig, r as reactExports, j as jsxRuntimeExports, c as cn, B as Button, b as ue } from "./index-DYFUyfbw.js";
...
import { M as Monitor } from "./monitor-CHOvYpqC.js";
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium", style: { color: "#1F2937" }, children: t("settings.branding.previewSelectDate") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 flex-wrap", children: ["Vr 12", "Za 13", "Zo 14", "Ma 15"].map((day, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: i === 1 ? { background: primaryColor, color: "#fff" } : {
                background: "#F3F4F6",
                color: "#1F2937",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 flex-wrap mt-1", children: ["12:00", "12:30", "19:00", "20:00"].map((slot, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              className: "px-2.5 py-1 rounded-lg text-xs font-medium",
              style: i === 2 ? { background: accentColor, color: "#fff" } : {
                background: "#F3F4F6",
                color: "#1F2937",
                border: "1px solid #E2E8F0"
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: cn(
                ...
                darkMode === "dark" ? "border-primary bg-[#0F172A]" : "border-border bg-muted/30"
              ),
