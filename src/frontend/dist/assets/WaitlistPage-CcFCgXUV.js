import { u as useTranslation, r as reactExports, j as jsxRuntimeExports, B as Button, b as ue, a as SkeletonTableRow, d as Clock, U as Users, n as formatDateShort, s as formatTime, t as Bell, i as Badge, C as CalendarDays } from "./index-DYFUyfbw.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogFooter } from "./dialog-CoPK5LCg.js";
import { L as Label } from "./label-whBlDZv1.js";
import { T as Textarea } from "./textarea-CvR61EHD.js";
import { c as useUpdateWaitlistEntry, d as useAddToWaitlist, e as useWaitlist, f as useOfferWaitlistSpot, g as useReofferWaitlistSpot, h as useRemoveWaitlistEntry } from "./useDashboard-DwEfJ7yB.js";
import { U as User } from "./user-BzH6B6oF.js";
import { M as Minus } from "./minus-hZf17MQi.js";
import { P as Plus } from "./plus-BLj3PxS_.js";
import { I as Input } from "./input-Be5T95oX.js";
import { M as Mail } from "./mail-Dr9le5WV.js";
import { P as Pen } from "./pen-C811hYtW.js";
import { R as RefreshCw } from "./refresh-cw-BePYxYna.js";
import { T as Trash2 } from "./trash-2-BocM61zf.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-D2BXPstq.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-BztHA3lN.js";
import { C as CircleCheck } from "./circle-check-4uI1R4ln.js";
import "./index-C6PNYWHZ.js";
import "./index-BSOAbKVe.js";
import "./index-FUSgI9cf.js";
const TIME_SLOTS$1 = [];
for (let h = 11; h <= 23; h++) {
...
function WaitlistTable({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", "aria-label": t("waitlist.title"), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: entries.map((entry, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        className: `hover:bg-muted/10 transition-colors group ${entry.status === "notified" ? "bg-blue-500/5" : ""}`,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
            ...
            (entry.status === "waiting" || entry.status === "notified") && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "sm",
                variant: "outline",
                className: `gap-1.5 text-xs h-7 px-2.5 hover-scale-xs ${entry.status === "notified" ? "border-blue-500/30 text-blue-400 hover:bg-blue-500/10" : "border-primary/30 text-primary hover:bg-primary/10"}`,
                onClick: () => onAction({
                  type: entry.status === "notified" ? "reoffer" : "offer",
                  entry
                }),
                disabled: isOffering,
                "data-ocid": entry.status === "notified" ? "reoffer-btn" : "offer-spot-btn",
                "aria-label": t("waitlist.offerLabel", {
                  name: entry.guestName
                }),
                children: [
                  entry.status === "notified" ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-3 w-3" }),
                  entry.status === "notified" ? t("waitlist.reofferButton") : t("waitlist.offerButton")
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function WaitlistPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    filtered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center text-sm text-muted-foreground", children: [
      waitingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-amber-500/10 text-amber-400 border border-amber-500/20 gap-1.5 px-2.5 py-1", children: [
      ...
      confirmedCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 gap-1.5 px-2.5 py-1", children: [
